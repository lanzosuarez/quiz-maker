...
1. **Use a supported Node version** — Prefer an active LTS or Current release that matches what `better-sqlite3` lists under `engines` in its [package page](https://www.npmjs.com/package/better-sqlite3).
2. **If you must build from source** — Install [Python 3](https://www.python.org/downloads/) (enable “Add to PATH”) and the **Visual Studio Build Tools** with the **Desktop development with C++** workload, then run `npm i` again.
